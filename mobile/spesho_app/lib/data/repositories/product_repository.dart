...
class ProductRepository implements IProductRepository {
  ...
  @override
  @override
  Future<ProductModel> createProduct(String name, double price, {int packageSize = 5, String category = 'unga'}) async {
    final res = await _api.post('/products/', {'name': name, 'unit_price': price, 'package_size': packageSize, 'category': category});
    return ProductModel.fromJson(res['product']);
  }

  @override
  Future<ProductModel> updateProduct(int id, {String? name, double? price, int? packageSize, String? category}) async {
